...
const COMP_COLORS: Record<string, string> = {
  "La Liga": "#ff4444",
  "Champions League": "#4a90e2",
  "Copa del Rey": "#f5a623",
  "UEFA Super Cup": "#7ed321",
  "Club World Cup": "#9b59b6",
};
    ...
    <div className="rounded-2xl overflow-hidden transition-all"
      ...
      <div className="flex items-center justify-between px-4 py-2"
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] font-semibold uppercase tracking-widest" style={{ color: compColor }}>
            {match.competition}
          </span>
          {match.live && (
...
export default function Soccer() {
  ...
  const allMatches = [...(data?.pastMatches || []), ...(data?.upcomingMatches || []), ...(data?.liveMatches || [])];
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-white/30 uppercase tracking-widest">All Competitions</p>
              </div>
            </div>
          </div>
          {rmStanding && (
          ...
          <>
            ...
            <div className="flex gap-1.5 rounded-2xl p-1" style={{ background: "rgba(255,255,255,0.04)" }}>
              {([
                ...
                { key: "standings", label: "La Liga", icon: Trophy },
              ...
              <div className="flex gap-2 overflow-x-auto pb-1" style={{ scrollbarWidth: "none" }}>
                {competitions.map(comp => (
                  <button key={comp} onClick={() => { click(); setCompFilter(comp); }}
                    ...
                    style={{
                      background: compFilter === comp
                        ? (comp === "All" ? "#c8a84b" : COMP_COLORS[comp] || "#888")
            ...
            {tab === "upcoming" && (
              <div className="space-y-3">
                {data?.liveMatches && filterMatches(data.liveMatches).length > 0 && (
                  <div className="space-y-3">
                    <div className="flex items-center gap-2">
                ...
                {filterMatches(data?.upcomingMatches || []).length === 0
