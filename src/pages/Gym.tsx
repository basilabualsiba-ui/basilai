...
const Gym = () => {
  ...
  useEffect(() => {
    ...
    // Check for action param to start workout
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background via-background to-gym/5 flex flex-col w-full">
      {/* Header with Gradient - Gym Red Theme */}
        ...
        <div className="container mx-auto px-4 py-3 flex items-center justify-between relative">
          <div className="flex items-center gap-3">
            <Button 
              ...
              className="hover:bg-gym/10 hover:text-gym transition-all duration-300 rounded-xl h-9 w-9"
            >
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-muted-foreground font-medium tracking-wide uppercase flex items-center gap-1">
                  <Flame className="h-2.5 w-2.5 text-gym" />
                  Stay consistent
                </p>
              </div>
            </div>
          ...
          <div className="flex items-center gap-2">
            <Button 
              ...
              className="flex items-center gap-2 rounded-xl border-gym/40 h-8 text-xs font-medium transition-all duration-300 bg-gym/10 text-gym hover:bg-gym/20"
            >
              <Play className="h-3.5 w-3.5" />
              <span className="hidden sm:inline">Track Exercise</span>
            </Button>
          </div>
        </div>
      </header>
      ...
      {/* Mobile Bottom Tabs with Glass Effect - Gym Red Theme */}
...
const GymWithLoading = () => {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-background via-background to-gym/5">
        <div className="text-center space-y-4">
          <div className="relative">
            <div className="p-5 rounded-3xl bg-gradient-to-br from-gym via-red-600 to-rose-600 shadow-2xl shadow-gym/40 animate-pulse">
              <Dumbbell className="h-10 w-10 text-white" />
            </div>
            <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-gym to-rose-500 opacity-60 blur-2xl animate-pulse" />
          </div>
