...
const Financial = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background via-background to-wallet/5 flex flex-col w-full">
      {/* Header with Gradient - Wallet Green Theme */}
          ...
          <div className="flex items-center gap-2">
            <Button 
              ...
              className={`flex items-center gap-2 rounded-xl border-border/40 h-8 text-xs font-medium transition-all duration-300 ${
                activeTab === 'budget' 
                  ? 'bg-wallet/15 text-wallet border-wallet/40 shadow-sm shadow-wallet/10' 
                  : 'hover:bg-wallet/10 hover:border-wallet/30 hover:text-wallet'
              }`}
            >
      ...
      {/* Mobile Bottom Tabs with Glass Effect - Wallet Green Theme */}
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-background via-background to-wallet/5">
        <div className="text-center space-y-4">
          <div className="relative">
            ...
            <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-wallet to-teal-500 opacity-60 blur-2xl animate-pulse" />
          </div>
