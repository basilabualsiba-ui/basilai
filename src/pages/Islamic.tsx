          ...
          <div className="container mx-auto px-4 py-4 flex items-center justify-between relative">
            <div className="flex items-center gap-4">
              <Button 
                ...
                className="hover:bg-amber-500/10 hover:text-amber-500 transition-all duration-300 rounded-xl"
              >
              ...
              <div className="flex items-center gap-3">
                <div className="relative">
                  ...
                  <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-amber-500 to-yellow-500 opacity-40 blur-lg -z-10" />
                </div>
                <div>
          ...
          <div className="bg-card/95 backdrop-blur-xl border-t border-border/30">
            <div className="grid grid-cols-2 h-16">
              {islamicItems.map((item) => (
                ...
                >
                  {activeTab === item.value && (
                    <div className="absolute inset-0 bg-amber-500/10 rounded-t-2xl" />
                  )}
