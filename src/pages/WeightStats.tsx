...
const WeightStats = () => {
  ...
  if (showIntro) return <ModuleIntroScreen icon={PersonStanding} title="Weight" subtitle="Track your progress" theme="weight" />;
      ...
      <header className="border-b border-border/20 bg-gradient-to-r from-background/95 via-background/90 to-background/95 backdrop-blur-xl sticky top-0 z-50">
        ...
        <div className="container mx-auto px-4 py-3 flex items-center justify-between relative">
          <div className="flex items-center gap-3">
            <Button variant="ghost" size="icon" onClick={() => { click(); navigate("/"); }} className="hover:bg-weight/10 hover:text-weight transition-all duration-300 rounded-xl h-9 w-9">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-bold bg-gradient-to-r from-foreground via-foreground to-foreground/70 bg-clip-text text-transparent">Weight</h1>
