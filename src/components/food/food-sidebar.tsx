import { Apple, Utensils, Calendar } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
...
const foodItems = [
  ...
  { title: "Meal Planner", value: "planner", icon: Calendar }
];
...
export function FoodSidebar({ activeTab, onTabChange }: FoodSidebarProps) {
