...
export function FinanceCard() {
  ...
  const formatAmount = (amount: number) => `${getCurrencySymbol('ILS')}${Math.round(amount)}`;
      ...
      >
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-xl bg-primary/20 flex items-center justify-center group-hover:animate-bounce-subtle">
        ...
        {spendingTrend.some(v => v > 0) && (
          <div className="mb-4">
            ...
            <Sparkline data={spendingTrend} color="accent" height={32} />
          </div>
        )}
